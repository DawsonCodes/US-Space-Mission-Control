// Pure normalization of Launch Library 2 payloads into the app's launch shape,
// plus the conservative field-level merge used to combine the two feeds.
//
// This module deliberately touches no browser API. The dashboard imports it
// through js/api.js, and the scheduled data workflow imports it directly under
// plain Node, so a launch is normalized exactly the same way in both places.
